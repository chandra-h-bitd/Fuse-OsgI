...
public class ObjectFactory {
    ...
    private final static QName _GetCustomerByNameResponse_QNAME = new QName("http://training.gpe.redhat.com/", "getCustomerByNameResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://training.gpe.redhat.com/", "saveCustomer");
    private final static QName _GetAllCustomers_QNAME = new QName("http://training.gpe.redhat.com/", "getAllCustomers");
    private final static QName _GetCustomerByName_QNAME = new QName("http://training.gpe.redhat.com/", "getCustomerByName");
    private final static QName _NoSuchCustomer_QNAME = new QName("http://training.gpe.redhat.com/", "NoSuchCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://training.gpe.redhat.com/", "saveCustomerResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpe.redhat.com/", name = "getCustomerByNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpe.redhat.com/", name = "saveCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpe.redhat.com/", name = "getCustomerByName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpe.redhat.com/", name = "saveCustomerResponse")
